        ...
        if key == "text":
            ...
            for elem in features:
                ...
                try:
                    ...
                    elif elem["embodiment_id"] == embodiment_tag_mapping[EmbodimentTag.PUSHT.value]:
                        processed_item = "A single top-down view video shows that a robot " + processed_item.lower()
                    else:
                    ...
                    if num_views > 1 and elem["embodiment_id"] == embodiment_tag_mapping[EmbodimentTag.AGIBOT.value]:
                        ...
                        item = "A single top-down view video shows that a robot " + str(item).lower()
                    else:
                        raise ValueError(f"Embodiment ID {elem['embodiment_id']} not supported.")
